...
/**
 * TextUploadForm Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class TextUploadForm implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TextUploadForm';
     ...
     * Sets user_data
     *
     * @param string|null $user_data Extra metadata to give to the parser. Only works with templates that are configured to accept user data.
     *
     * @return $this
     */
