...
/**
 * APIIndexBody Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class APIIndexBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'APIIndexBody';
    ...
    protected static $openAPITypes = [
        'data' => '\KlippaOCRAPI\Model\APIIndex',
        'request_id' => 'string',
        'result' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \KlippaOCRAPI\Model\APIIndex|null
     */
     ...
     * Sets data
     *
     * @param \KlippaOCRAPI\Model\APIIndex|null $data data
     *
     * @return $this
     */
