...
/**
 * GetTemplates Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetTemplates implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTemplates';
    ...
    protected static $openAPITypes = [
        'templates' => 'map[string,\KlippaOCRAPI\Model\RespTemplate]'
    ];
     ...
     * Gets templates
     *
     * @return map[string,\KlippaOCRAPI\Model\RespTemplate]|null
     */
     ...
     * Sets templates
     *
     * @param map[string,\KlippaOCRAPI\Model\RespTemplate]|null $templates templates
     *
     * @return $this
     */
