...
/**
 * RespTemplate Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RespTemplate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'respTemplate';
     ...
     * Sets title
     *
     * @param string|null $title The name of the template
     *
     * @return $this
     */
