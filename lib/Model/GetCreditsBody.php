...
/**
 * GetCreditsBody Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetCreditsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCreditsBody';
    ...
    protected static $openAPITypes = [
        'data' => '\KlippaOCRAPI\Model\GetCredits',
        'request_id' => 'string',
        'result' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \KlippaOCRAPI\Model\GetCredits|null
     */
     ...
     * Sets data
     *
     * @param \KlippaOCRAPI\Model\GetCredits|null $data data
     *
     * @return $this
     */
