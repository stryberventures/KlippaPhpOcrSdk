...
/**
 * CreatePublicKeyForm Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreatePublicKeyForm implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePublicKeyForm';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['scan_limit'] === null) {
            $invalidProperties[] = "'scan_limit' can't be null";
        }
        if (($this->container['scan_limit'] > 100)) {
            $invalidProperties[] = "invalid value for 'scan_limit', must be smaller than or equal to 100.";
        }

        if (($this->container['scan_limit'] < 1)) {
            $invalidProperties[] = "invalid value for 'scan_limit', must be bigger than or equal to 1.";
        }

        if ($this->container['valid_time'] === null) {
            $invalidProperties[] = "'valid_time' can't be null";
        }
        if (($this->container['valid_time'] > 3600)) {
            $invalidProperties[] = "invalid value for 'valid_time', must be smaller than or equal to 3600.";
        }

        if (($this->container['valid_time'] < 60)) {
            $invalidProperties[] = "invalid value for 'valid_time', must be bigger than or equal to 60.";
        }
     ...
     * Sets scan_limit
     *
     * @param int $scan_limit The amount of scans the public key can do.
     *
     * @return $this
     */
    public function setScanLimit($scan_limit)
    {
        ...
        if (($scan_limit > 100)) {
            throw new \InvalidArgumentException('invalid value for $scan_limit when calling CreatePublicKeyForm., must be smaller than or equal to 100.');
        }
        if (($scan_limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $scan_limit when calling CreatePublicKeyForm., must be bigger than or equal to 1.');
        }
     ...
     * Sets valid_time
     *
     * @param int $valid_time The amount of seconds the public key should be valid. With a minimum of 1 minute (60) and a maximum of 1 hour (3600).
     *
     * @return $this
     */
    public function setValidTime($valid_time)
    {
        ...
        if (($valid_time > 3600)) {
            throw new \InvalidArgumentException('invalid value for $valid_time when calling CreatePublicKeyForm., must be smaller than or equal to 3600.');
        }
        if (($valid_time < 60)) {
            throw new \InvalidArgumentException('invalid value for $valid_time when calling CreatePublicKeyForm., must be bigger than or equal to 60.');
        }
