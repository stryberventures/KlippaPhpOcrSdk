...
/**
 * EuropeanPassportBody Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class EuropeanPassportBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EuropeanPassportBody';
    ...
    protected static $openAPITypes = [
        'data' => '\KlippaOCRAPI\Model\EuropeanPassport',
        'request_id' => 'string',
        'result' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \KlippaOCRAPI\Model\EuropeanPassport|null
     */
     ...
     * Sets data
     *
     * @param \KlippaOCRAPI\Model\EuropeanPassport|null $data data
     *
     * @return $this
     */
