...
/**
 * GetPublicKeyInfoBody Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetPublicKeyInfoBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPublicKeyInfoBody';
    ...
    protected static $openAPITypes = [
        'data' => '\KlippaOCRAPI\Model\GetPublicKeyInfo',
        'request_id' => 'string',
        'result' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \KlippaOCRAPI\Model\GetPublicKeyInfo|null
     */
     ...
     * Sets data
     *
     * @param \KlippaOCRAPI\Model\GetPublicKeyInfo|null $data data
     *
     * @return $this
     */
