...
/**
 * GetTemplatesBody Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetTemplatesBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTemplatesBody';
    ...
    protected static $openAPITypes = [
        'data' => '\KlippaOCRAPI\Model\GetTemplates',
        'request_id' => 'string',
        'result' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \KlippaOCRAPI\Model\GetTemplates|null
     */
     ...
     * Sets data
     *
     * @param \KlippaOCRAPI\Model\GetTemplates|null $data data
     *
     * @return $this
     */
