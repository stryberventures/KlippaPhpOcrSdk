...
/**
 * CreatePublicKey Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreatePublicKey implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createPublicKey';
     ...
     * Sets public_key
     *
     * @param string|null $public_key The public key to use when using the API.
     *
     * @return $this
     */
