...
/**
 * ReceiptLineItemItem Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ReceiptLineItemItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceiptLineItemItem';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['amount_each'] = isset($data['amount_each']) ? $data['amount_each'] : null;
     ...
     * @return int|null
     */
    public function getAmountEach()
    {
        return $this->container['amount_each'];
    }

    /**
     * Sets amount_each
     *
     * @param int|null $amount_each amount_each
     *
     * @return $this
     */
    public function setAmountEach($amount_each)
    {
        $this->container['amount_each'] = $amount_each;
     ...
     * Sets amount_ex_vat
     *
     * @param double|null $amount_ex_vat amount_ex_vat
     *
     * @return $this
     */
     ...
     * Sets vat_amount
     *
     * @param double|null $vat_amount vat_amount
     *
     * @return $this
     */
     ...
     * Sets vat_percentage
     *
     * @param int|null $vat_percentage vat_percentage
     *
     * @return $this
     */
