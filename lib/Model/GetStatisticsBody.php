...
/**
 * GetStatisticsBody Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetStatisticsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getStatisticsBody';
    ...
    protected static $openAPITypes = [
        'data' => '\KlippaOCRAPI\Model\StatRow[]',
        'request_id' => 'string',
        'result' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \KlippaOCRAPI\Model\StatRow[]|null
     */
     ...
     * Sets data
     *
     * @param \KlippaOCRAPI\Model\StatRow[]|null $data data
     *
     * @return $this
     */
