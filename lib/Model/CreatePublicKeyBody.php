...
/**
 * CreatePublicKeyBody Class Doc Comment
 *
 * @category Class
 * @package  KlippaOCRAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreatePublicKeyBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createPublicKeyBody';
    ...
    protected static $openAPITypes = [
        'data' => '\KlippaOCRAPI\Model\CreatePublicKey',
        'request_id' => 'string',
        'result' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \KlippaOCRAPI\Model\CreatePublicKey|null
     */
     ...
     * Sets data
     *
     * @param \KlippaOCRAPI\Model\CreatePublicKey|null $data data
     *
     * @return $this
     */
