...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://custom-ocr.klippa.com/api/v1';
    ...
    {
        $report  = 'PHP SDK (KlippaOCRAPI) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v0-13-45 - 71d7186abd1c5492b0e3ea562d8b7c6b4a0017ae' . PHP_EOL;
